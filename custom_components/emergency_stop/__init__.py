...
async def async_setup_entry(hass: HomeAssistant, entry: ConfigEntry) -> bool:
    ...
    # Before the first evaluation, so a latched alarm is already armed when the
    # entities appear rather than being cleared by the restart.
    await coordinator.async_restore_latches()
